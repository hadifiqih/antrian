    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <select class="custom-select select2" id="infoPelanggan" name="modalInfoPelanggan" required>
        ...
        <div class="modal-footer">
            ...
            <input id="subPelanggan" type="submit" class="btn btn-primary" id="submitPelanggan" value="Tambah"><span id="loader" class="loader" style="display: none;"></span>
        </div>
    </form>
    </div>
    </div>
