    ...
    <div class="col-md-12">
        ...
        <div class="card mb-4">
            <div class="card-header">
                ...
                <button class="btn btn-primary btn-sm float-right" onclick="penugasanOtomatis({{ $antrian->id }})"><i class="fa-solid fa-wand-magic-sparkles"></i> Penugasan Otomatis</button>
            </div>
            <div class="card-body">
        {{-- Data Barang --}}
