                ...
                <div class="card-body pt-0">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control" id="dikirimDari" name="dikirimDari" required> @foreach ($cabangs as $cabang) <option value="{{ $cabang->id }}">{{ $cabang->nama_cabang }}</option> @endforeach </select>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-check usePelanggan mb-2" style="display: none">
                                ...
                                <label class="form-check-label" for="useCustomerData"> Gunakan data pelanggan </label>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#btnBuatPesanan').on('click', function(){
            ...
            var total = parseInt(totalText);
            var bayar = parseInt(bayarText);
            $('#btnBuatPesanan').prop('disabled', true);
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    setTimeout(function() {
                    window.location.href = '/pos/laporan-bahan';
                    }, 1500);
                },
                error: function(data) {
                    Swal.fire({
