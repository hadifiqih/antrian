                ...
                <div class="card-body">
                    <form action="{{ route('iklan.update', $iklan->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="marol" name="marol" required>
                                ...
                                @foreach ($marol as $item)
                                    <option value="{{ $item->id }}" {{ $item->id == $iklan->user_id ? 'selected' : ''}}>{{ $item->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="biaya_iklan" name="biaya_iklan" value="{{ $iklan->biaya_iklan }}">
                        </div>
